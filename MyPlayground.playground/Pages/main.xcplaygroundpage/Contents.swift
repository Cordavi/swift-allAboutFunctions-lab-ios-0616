 ...
 */
let favoriteCharacter = "Judge Judy"
...
func numberOfProblems(number:Int) {
    print("I've got \(number) problems but Swift ain't one!")
}
numberOfProblems(18)
 ...
 */
func bandRanking(name:String, rank:Int) {
    print("My #\(rank) favorite band is \(name).")
}
bandRanking("Green Day", rank: 20)
...
madLib("Jon Snow", noun: "day", preposition: "around")
 ...
 */
func characterSoundOff(name:String) -> String {
    return "To infinity and beyond \(name)!"
}
characterSoundOff("Jon Snow")
